...
namespace Firma.Intranet.Migrations
{
    ...
    [Migration("20250325212118_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Firma.Intranet.Models.CMS.Topicality", b =>
                {
            ...
            modelBuilder.Entity("Firma.Intranet.Models.Customers.Order", b =>
                {
            ...
            modelBuilder.Entity("Firma.Intranet.Models.Customers.OrderItem", b =>
                {
            ...
            modelBuilder.Entity("Firma.Intranet.Models.Customers.User", b =>
                {
                    b.Property<int>("IdUser")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Firma.Intranet.Models.Shop.Cart", b =>
                {
            ...
            modelBuilder.Entity("Firma.Intranet.Models.Shop.ProductType", b =>
                {
                    b.Property<int>("IdProductType")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Firma.Intranet.Models.Customers.Order", b =>
                {
                    b.HasOne("Firma.Intranet.Models.Customers.User", "User")
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("Firma.Intranet.Models.Customers.OrderItem", b =>
                {
                    b.HasOne("Firma.Intranet.Models.Customers.Order", "Order")
                        .WithMany("OrderItems")
            ...
            modelBuilder.Entity("Firma.Intranet.Models.Shop.Product", b =>
                {
                    b.HasOne("Firma.Intranet.Models.Shop.ProductType", "ProductType")
                        .WithMany("Products")
