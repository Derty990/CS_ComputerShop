...
namespace Firma.Intranet.Controllers
{
    public class ProductController : Controller
    {
        ...
        public ProductController(FirmaIntranetContext context)
        {
            _context = context;
        }
        ...
        {
            var firmaIntranetContext = _context.Product.Include(p => p.ProductType);
        ...
        {
            ViewData["IdProductType"] = new SelectList(_context.Set<ProductType>(), "IdProductType", "Name");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("IdProduct,Code,Name,Price,PhotoUrl,Description,IdProductType")] Product product)
        {
            ...
            ViewData["IdProductType"] = new SelectList(_context.Set<ProductType>(), "IdProductType", "Name", product.IdProductType);
            return View(product);
        }
